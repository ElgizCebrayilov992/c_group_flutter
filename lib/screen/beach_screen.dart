...
class BeachScreen extends StatefulWidget {
  int colorIndex;
  List<Hrsb> beach;
  BeachScreen(this.beach, this.colorIndex);
  @override
        ...
        children: [
          ...
          Container(
            ...
            child: Center(
              child: Text(
                """
                All the hotels, brands and collections, offer the best to travelers.

Resant Hotels & Resorts offers unique, personalized, and quality value styles of hospitality, which meet the widest range of needs with exclusive and selected benefits.
                """,
                style: TextStyle(
                    fontSize: 14,
                    fontWeight: FontWeight.bold,
  ...
  Widget bodyPackages(List<Hrsb> list) {
    widget.beach.asMap().forEach((key, value) {
      return Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Material(
